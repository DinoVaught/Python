...
#		Logging.log.log_debug('**** 1 len(currentValue.value)', str(len(val)), val)
#		
#		for c in val:
#			Logging.log.log_debug('**** 11 **', c,  str(ord(c)))	
...
#		
#		for c in val:
#			Logging.log.log_debug('**** 22 **', c,  str(ord(c)))
...
#		Logging.log.log_debug('****', 'pre ', str(pre))
#		Logging.log.log_debug('****', 'message ', str(message))
