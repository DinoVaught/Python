...
# ...repos\Gages\IgnitionScripts\GatewayScripts
...
try:
	...
	seqNum = system.db.runNamedQuery("Gages", "Printing/getToteTagsPrintedCount", {"p_skidID":skid_ID})
	seqNum += 1
	
	printerName = GageID
#	if GageID == 'G21': printerName = 'G20'
	
	tote_id = -1
#	skd_id = skid_ID * -1 # *********************
	tote_rec = system.db.runNamedQuery('Gages', 'Skid/add_tote', {'wip_id':wipNum,
																  'skid_id':skid_ID,
																  'user_id':user,
																  'part_count':batchCount,
																  'is_short':'N',
																  'tote_seq':seqNum})
	if tote_rec.getRowCount() > 0:
		tote_id = int(tote_rec.getValueAt(0, 0))


#	Debug.LogMessage('Gage: ' + GageID, str(skid_ID), str(tote_id) + ' - ')
	...
	# INSERT INTO mes.skid_parts (wip_id, skid_id, t_stamp, use, tote_part_count, is_short)
...
#	Debug.LogMessage('333', '2', str(seqNum))
# ==========================================================================================================
...
# ==========================================================================================================
	...
	eParams = {'msgID':GageID + ', ' + heatNum,
             'message':getattr(e, 'message', repr(e)),
           'msgSource':'GageAutoPrint_ToteTag... S47AX59'}
